...
const v1Routes: Routes = [
    {path: 'zip-code', component: ZipCodeComponent },
        ...
        // children: [
        //     { path: 'depreciation', component: DepreciationComponent, children: depreciationRoutes, data: {securityAction: 'incometax.depreciation'} },
        //     { path: 'dashboard', component: ITDashbardComponent },
        //     { path: 'partnership', component: PartnershipComponent, data: {securityAction: 'administration.partnership'} },
        //     { path: 'disguised-sale', component: DisguisedSaleComponent },
        //     { path: 'like-kind-exchange', component: LikeKindExchangeComponent },
        //     { path: 'partnership-detail', component: PartnershipCrudComponent, data: {securityAction: 'administration.partnership'}, canDeactivate: [CanDeactivateGuard] },
